...
> extends Vue {
    ...
    protected timedOut() {
        ...
        this.statusScreenMessage = this.$t('Please go back to the shop and restart the process.') as string;
        this.statusScreenMainAction = () => this.backToShop();
        this.statusScreenMainActionText = this.$t('Go back to shop') as string;
